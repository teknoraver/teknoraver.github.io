...
I worked on different parts of the kernel, from the network stack to eBPF, with minor contributions to other subsystems like block devices.  
...
For me, this was an opportunity to learn Go and to work on a project not directly related to the Linux kernel.

## systemd
At Facebook, I'm [working on systemd](https://github.com/systemd/systemd/commits?author=teknoraver) upstream, developing new features and fixing bugs.
...
I have a lot of small changes in dozens of projects. I use [OpenHub](https://openhub.net/accounts/teknoraver/positions) to keep track of them.
