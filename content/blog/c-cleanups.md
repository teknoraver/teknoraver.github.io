...
They bring automatic resource management to C in a way that feel
natural and eliminates the entire class of resource management bugs.
...
The result is code that is more readablem maintainable and less prone to resource leaks and other common C pitfalls.  
